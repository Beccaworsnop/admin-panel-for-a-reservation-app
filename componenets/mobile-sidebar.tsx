...
export function MobileSidebar({ activeSection, onSectionChange, isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col z-50 transform transition-transform duration-300 ease-in-out lg:hidden",
