      ...
      <Card className="p-4 mb-6">
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 lg:gap-4">
          <div className="flex-1 relative">
            ...
            <Input placeholder="Search apartment reservations..." className="pl-10" />
          </div>
      ...
      <Card>
        <div className="p-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">
            Apartment Reservations ({apartmentReservations.length})
          </h3>
        </div>
      ...
      {showNewReservationModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            <h3 className="text-lg font-semibold mb-4">New Apartment Reservation</h3>
            <p className="text-gray-600 mb-4">
              Apartment reservation form with lease terms, utilities, and tenant details would be implemented here.
            </p>
            <div className="flex gap-2">
              ...
              <Button
                onClick={() => {
                  console.log("[v0] Creating new apartment reservation...")
